    ...
    >
      <div>
        ...
        <nav className="mt-6 flex flex-col gap-1 px-3">
          <MenuItem icon={<RiHomeLine />} onClick={() => navigate("/homeuser")} label="Início" open={open} active={isActive("/")} />
...
function MenuItem({ icon, label, open, onClick, active }) {
  return (
    <button
      onClick={onClick}
      className={`
        relative group flex items-center w-full gap-4 px-3 pl-2 py-3 rounded-xl
